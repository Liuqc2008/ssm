...
public class WeixinSendGroupRedPackage {
	@Test
	public void SendGroupRedPack() throws Exception {
		...
		model.SendGroupRedPackage sendRedPack = new model.SendGroupRedPackage();
        ...
        sendRedPack.setTotal_amount(500);					//付款金额，单位分
        sendRedPack.setTotal_num(3);				//红包发放总人数 total_num=1
        sendRedPack.setAmt_type("ALL_RAND");				//红包发放总人数 total_num=1
        ...
        WeiXinApi.SendGroupRedPackage(sendRedPack);
	}
}
